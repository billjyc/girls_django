# Generated by Django 4.1.7 on 2023-04-06 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "variety",
                    models.IntegerField(db_column="variety", verbose_name="综艺感"),
                ),
                ("act", models.IntegerField(db_column="act", verbose_name="演技")),
                ("health", models.IntegerField(db_column="health", verbose_name="健康")),
                (
                    "concentration",
                    models.IntegerField(db_column="concentration", verbose_name="工作投入"),
                ),
                (
                    "leadership",
                    models.IntegerField(db_column="leadership", verbose_name="领导力"),
                ),
                (
                    "pressure",
                    models.IntegerField(db_column="pressure", verbose_name="抗压能力"),
                ),
            ],
            options={
                "verbose_name": "成员能力",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "batch",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="期数"
                    ),
                ),
                (
                    "birthday",
                ...
                (
                    "english_name",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="英文名"
                    ),
                ),
                (
                    "join_time",
                    models.DateField(blank=True, null=True, verbose_name="入团时间"),
                ),
                (
                    "link",
                    models.CharField(
                        blank=True, max_length=300, null=True, verbose_name="资料链接"
                    ),
                ),
                (
                    "image_link",
                ...
                (
                    "pid",
                    models.IntegerField(blank=True, null=True, verbose_name="期数编号"),
                ),
            ],
            options={
                "verbose_name": "成员信息",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="公演名称"
                    ),
                ),
                (
                    "debut_date",
                    models.DateField(blank=True, null=True, verbose_name="首演日期"),
                ),
                (
                    "end_date",
                    models.DateField(blank=True, null=True, verbose_name="千秋乐日期"),
                ),
                (
                    "link",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="公演详情页链接"
                    ),
                ),
                (
                    "logo_link",
                    models.CharField(max_length=100, verbose_name="公演logo链接"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateTimeField(blank=True, null=True, verbose_name="公演时间"),
                ),
                (
                    "description",
                    models.CharField(
                ...
                (
                    "video_url",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="视频链接"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.IntegerField(
                        primary_key=True, serialize=False, verbose_name="队伍编号"
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        blank=True, max_length=30, null=True, verbose_name="队伍名称"
                    ),
                ),
                (
                    "found_date",
                    models.DateField(blank=True, null=True, verbose_name="建队时间"),
                ),
                ...
                (
                    "background_color",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="应援色"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="歌曲名称"
                    ),
                ),
